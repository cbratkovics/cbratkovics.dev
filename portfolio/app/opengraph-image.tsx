...
export const alt = "Christopher J. Bratkovics — Trustworthy data foundations, clear metrics, defensible decisions";
...
export default function Image() {
  return new ImageResponse(
    <div style={{ width: "100%", height: "100%", display: "flex", flexDirection: "column", justifyContent: "center", padding: 80, color: "white", background: "linear-gradient(135deg, #0a0a0f 15%, #172554 55%, #4c1d95 100%)" }}>
      ...
      <div style={{ display: "flex", fontSize: 38, color: "#e5e7eb", marginTop: 28 }}>Trustworthy data foundations. Clear metrics.</div>
      <div style={{ display: "flex", fontSize: 38, color: "#e5e7eb", marginTop: 10 }}>Defensible decisions.</div>
      <div style={{ display: "flex", fontSize: 25, color: "#a5f3fc", marginTop: 24 }}>Data Scientist · Analytics Engineer · Applied AI</div>
