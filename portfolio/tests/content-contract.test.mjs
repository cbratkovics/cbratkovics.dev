...
test("project structure, repositories, and capability boundaries remain scoped", () => {
  ...
  ordered(content, ["Fantasy Football Projection Pipeline", "SQL Genius AI | SQL Analytics Playground", "AI Chat System | Multi-Provider LLM Gateway", "NBA Stat Predictor", "Document Intelligence | Local-First Retrieval Service"]);
